...
; CHECK-NEXT:     [N] -> { Stmt_S0[] -> Stmt_S1[o0] : N >= 11 and 0 <= o0 <= 1023; Stmt_S0[] -> Stmt_S2[] : N >= 11; Stmt_S1[i0] -> Stmt_S2[] : N >= 11 and 0 <= i0 <= 1023 }
; CHECK-NEXT: WAR dependences:
; CHECK-NEXT:     [N] -> { Stmt_S1[1023] -> Stmt_S2[] : N >= 11 }
; CHECK-NEXT: WAW dependences:
; CHECK-NEXT:     [N] -> { Stmt_S0[] -> Stmt_S1[o0] : N >= 11 and 0 <= o0 <= 1023; Stmt_S0[] -> Stmt_S2[] : N >= 11; Stmt_S1[i0] -> Stmt_S2[] : N >= 11 and 0 <= i0 <= 1023 }
; CHECK-NEXT: Reduction dependences:
; CHECK-NEXT:     [N] -> { Stmt_S1[i0] -> Stmt_S1[o0] : N >= 11 and i0 >= 0 and i0 < o0 <= 1023 }
;
