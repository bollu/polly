...
; CHECK-NEXT:     { Stmt_S2[i0, i1] -> Stmt_S3[1 - i1] : i0 >= 0 and 0 <= i1 <= 1 - i0; Stmt_S3[i0] -> Stmt_S2[o0, 1 - i0] : 0 <= i0 <= 1 and i0 < o0 <= 98; Stmt_S1[i0] -> Stmt_S3[2 + i0] : 0 <= i0 <= 96 }
; CHECK-NEXT: WAR dependences:
; CHECK-NEXT:     { Stmt_S2[i0, 1 - i0] -> Stmt_S3[i0] : 0 <= i0 <= 1; Stmt_S3[i0] -> Stmt_S2[1 + i0, 1 - i0] : 0 <= i0 <= 1; Stmt_S1[i0] -> Stmt_S3[2 + i0] : 0 <= i0 <= 96 }
; CHECK-NEXT: WAW dependences:
; CHECK-NEXT:     { Stmt_S2[i0, i1] -> Stmt_S3[1 - i1] : i0 >= 0 and 0 <= i1 <= 1 - i0; Stmt_S3[i0] -> Stmt_S2[o0, 1 - i0] : 0 <= i0 <= 1 and i0 < o0 <= 98; Stmt_S1[i0] -> Stmt_S3[2 + i0] : 0 <= i0 <= 96 }
; CHECK-NEXT: Reduction dependences:
; CHECK-NEXT:     { Stmt_S2[i0, i1] -> Stmt_S2[o0, i1] : i0 >= 0 and i1 >= 0 and i0 < o0 <= 99 - i1 and o0 <= 98 }
;
;    void f(int *sum) {
;      int i, j;
;      for (i = 0; i < 99; i++) {
