...
; CHECK-NEXT:     { Stmt_for_body3[i0, i1] -> Stmt_for_body3[i0, o1] : 0 <= i0 <= 1023 and i1 >= 0 and i1 < o1 <= 1023; Stmt_for_body3[i0, i1] -> Stmt_for_body3[o0, i1] : i0 >= 0 and 0 <= i1 <= 1023 and i0 < o0 <= 1023 }
;
