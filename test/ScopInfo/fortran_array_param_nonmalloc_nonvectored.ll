...
; RUN: -polly-process-unprofitable -polly-scops  -polly-allow-nonaffine -polly-invariant-load-hoisting < %s | FileCheck %s
...
; ModuleID = 'fortran_array_param_nonmalloc_nonvectored.ll'
source_filename = "fortran_array_param_nonmalloc_nonvectored.ll"
